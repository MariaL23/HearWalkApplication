...
public class SnapshotHandlerTesting: MonoBehaviour
{    
    [Header("OSC Settings")]  
    ...
    public SensorDataProcessor dataProcessor;
    ...
    public async void MessageReceived(OSCMessage message)
    {     
         await Task.Delay(0);
